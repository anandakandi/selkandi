...
public class ExcelReader {
	public static void main(String[] args) throws IOException {
		...
		getExcelValue(fileName, sheetName, "State", rowNum).trim();
	}
	

	public static String getExcelValue(String fileName, String sheetName, String columnName, int rowNum) throws IOException {
